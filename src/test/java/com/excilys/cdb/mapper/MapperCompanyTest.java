...
public class MapperCompanyTest {
	...
	public void mapModelToDTOTest(){
		...
		assertEquals("Mapped DTOCompany isn't equal to the expected DTOCompany",dtoCompany,mapper.modelToDTO(company));
	}
	...
	public void mapDTOToModelTest(){
		Company company = new Company(1,"Apple");
		DTOCompany dtoCompany = new DTOCompany("1","Apple");
		assertEquals("Mapped Company isn't equal to the expected Company",company,mapper.DTOToModel(dtoCompany));
	}
}
