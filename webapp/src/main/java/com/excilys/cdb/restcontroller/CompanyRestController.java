...
public class CompanyRestController {
	...
	public List<DTOCompany> findAll(@RequestParam(value="search", required = false) String search,
			 						@RequestParam(value="range",required = false) String range) throws PageNotFoundException, BadRequestException{
	...
	public void create(@RequestBody DTOCompany company) throws NotAValidComputerException, CompanyNotFoundException {
		this.serviceCompany.insert(company);
	}
	
	@PutMapping("/{id}")
	@ResponseStatus(HttpStatus.OK)
	public void update(@PathVariable("id") int id, @RequestBody DTOCompany company) throws CompanyNotFoundException {
